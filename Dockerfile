...
ENV PATH /home/cerberus/.cabal/bin:/opt/cabal/1.22/bin:/opt/ghc/7.8.4/bin:/opt/happy/1.19.4/bin:/opt/alex/3.1.3/bin:$PATH
...
RUN mkdir /home/cerberus/communities && mkdir /home/cerberus/featured
ADD notebooks/ /home/cerberus/
ADD datasets/ /home/cerberus/datasets/
...
# Featured notebooks
RUN git clone --depth 1 https://github.com/jvns/pandas-cookbook.git /home/cerberus/featured/pandas-cookbook/
RUN git clone --depth 1 https://github.com/gibiansky/IHaskell.git /home/cerberus/IHaskell/ && \
    mv /home/cerberus/IHaskell/ihaskell-display/ihaskell-widgets/Examples /home/cerberus/featured/ihaskell-widgets && \
    rm -r /home/cerberus/IHaskell
